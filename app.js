...
app.post('/devices', function(req, res) {
    ...
    var object = {
        ...
        dsp: templates[typeIndex].dsp,
        or: templates[typeIndex].or
    }
    map.set(name, object);
...
function createSMD(name, typeIndex) {
    ...
    var dsp = templates[typeIndex].dsp
    var or = templates[typeIndex].or
